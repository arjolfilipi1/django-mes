...
class InitialInventory(generic.BO):
    ...
    def init_entry(self,request=None):
        """
        Execution period beginning storage
        """
        count = InitItem.objects.filter(master=self).count()
        if count > 0:
            with transaction.atomic():
...
class StockIn(generic.BO):
    ...
    status = models.CharField(_("status"),max_length=const.DB_CHAR_CODE_2,default='0',choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"),blank=True,null=True)
    po = models.ForeignKey(PurchaseOrder,verbose_name=_("purchase order"),null=True,limit_choices_to={"entry_status":"0"},blank=True,on_delete=models.SET_NULL)
...
class StockOut(generic.BO):
    ...
    wo = models.ForeignKey(WorkOrder,verbose_name=_("work order"),blank=True,null=True,on_delete=models.SET_NULL)
    description = models.TextField(_("description"),blank=True,null=True)
    amount = models.DecimalField(_("money of amount"),max_digits=14,decimal_places=4,blank=True,null=True)
    user = models.ForeignKey(User,verbose_name=_("out user"),blank=True,null=True,on_delete=models.SET_NULL)
    status = models.CharField(_("status"),max_length=const.DB_CHAR_CODE_2,default='0',choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"),blank=True,null=True)
...
class InOutDetail(models.Model):
    ...
    warehouse = models.ForeignKey(Warehouse,verbose_name=_("warehouse"),blank=True,null=True,on_delete=models.SET_NULL)
    material = models.ForeignKey(Material,verbose_name=_("material"),limit_choices_to={"is_virtual":"0"},blank=True,null=True,on_delete=models.SET_NULL)
...
class InItem(InOutDetail):
    ...
    po_item = models.ForeignKey(POItem,verbose_name=_("po item"),blank=True,null=True,on_delete=models.SET_NULL)
...
class OutItem(InOutDetail):
    ...
    inventory = models.ForeignKey(Inventory,blank=True,null=True,verbose_name=_("inventory material"),on_delete=models.SET_NULL)
...
class ReturnItem(InOutDetail):
    ...
    out_item = models.ForeignKey(OutItem,blank=True,null=True,verbose_name=_('out item'),on_delete=models.SET_NULL)
