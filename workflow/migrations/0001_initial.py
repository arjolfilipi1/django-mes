    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'app_label__in': ['basedata', 'organ']}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='content type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('starter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='starter', to=settings.AUTH_USER_MODEL, verbose_name='start user')),
                ('modal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='workflow.modal', verbose_name='workflow model')),
                ('current_nodes', models.ManyToManyField(blank=True, to='workflow.node', verbose_name='current node')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='workflow.node', verbose_name='workflow node')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inst', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='workflow.instance', verbose_name='workflow instance')),
                ('node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='workflow.node', verbose_name='current node')),
