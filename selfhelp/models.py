...
class WorkOrder(generic.BO):
    ...
    refer = models.ForeignKey("self",verbose_name=_("refer wo"),blank=True,null=True,on_delete = models.SET_NULL)
    ...
    service = models.ForeignKey(Material,verbose_name=_("service name"),null=True,blank=True,limit_choices_to={"is_virtual":"1"},on_delete = models.SET_NULL)
    project = models.ForeignKey(Project,verbose_name=_("project"),null=True,blank=True,on_delete = models.SET_NULL)
    ...
    attach = models.FileField(_('attach'),blank=True,null=True,help_text=u'Work order attachments, details are not imported.')
    detail = models.FileField(_('to be imported detail'),blank=True,null=True,help_text=u'You can import the demand details. For the template, please refer to document FD0007')
...
class WOItem(models.Model):
    ...
    """
    workorder = models.ForeignKey(WorkOrder,verbose_name=_("workorder"),on_delete = models.CASCADE)
    material = models.ForeignKey(Material,verbose_name=_("material"),null=True,blank=True,limit_choices_to={"is_virtual":"0"},on_delete = models.SET_NULL)
    amount = models.DecimalField(_("amount"),max_digits=10,decimal_places=4,blank=True,null=True)
    measure = models.ForeignKey(Measure,verbose_name=_('measure'),blank=True,null=True,on_delete = models.SET_NULL)
...
class Reimbursement(generic.BO):
    ...
    description = models.TextField(_("description"),blank=True,null=True)
    project = models.ForeignKey(Project,verbose_name=_("project"),on_delete = models.CASCADE)
    wo = models.ForeignKey(WorkOrder,verbose_name=_("work order"),null=True,blank=True,on_delete = models.SET_NULL)
    user = models.ForeignKey(User,verbose_name=_("user"),blank=True,null=True,on_delete = models.SET_NULL)
    org = models.ForeignKey(OrgUnit,verbose_name=_("cost center"),blank=True,null=True,on_delete = models.SET_NULL)
    ...
    loan = models.ForeignKey(Loan,verbose_name=_("loan record"),blank=True,null=True,on_delete = models.SET_NULL)
    loan_amount = models.DecimalField(_("loan amount"),max_digits=10,decimal_places=2,blank=True,null=True)
    logout_amount = models.DecimalField(_("logout amount"),max_digits=10,decimal_places=2,blank=True,null=True)
...
class Activity(generic.BO):
    ...
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_120)
    parent = models.ForeignKey('self',verbose_name=_("parent"),blank=True,null=True,on_delete = models.SET_NULL)
    description = models.TextField(_("description"),blank=True,null=True)
    ...
    room = models.ForeignKey(Material,verbose_name=_("room"),blank=True,null=True,limit_choices_to={'tp':20},on_delete = models.SET_NULL)
