    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='selfhelp.activity', verbose_name='parent')),
                ('room', models.ForeignKey(blank=True, limit_choices_to={'tp': 20}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='basedata.material', verbose_name='room')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_time', models.DateTimeField(blank=True, null=True, verbose_name='pay time')),
                ('pay_user', models.CharField(blank=True, max_length=40, null=True, verbose_name='pay user')),
                ('loan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='selfhelp.loan', verbose_name='loan record')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='organ.orgunit', verbose_name='cost center')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='basedata.project', verbose_name='project')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.CharField(choices=[], default='D', max_length=4, verbose_name='classification')),
                ('status', models.CharField(blank=True, choices=[], default='NEW', max_length=6, null=True, verbose_name='status')),
                ('answer', models.TextField(blank=True, null=True, verbose_name='answer')),
                ('attach', models.FileField(blank=True, help_text='Work order attachments, details are not imported.', null=True, upload_to='', verbose_name='attach')),
                ('detail', models.FileField(blank=True, help_text='You can import the demand details. For the template, please refer to document FD0007', null=True, upload_to='', verbose_name='to be imported detail')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='basedata.project', verbose_name='project')),
                ('refer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='selfhelp.workorder', verbose_name='refer wo')),
                ('service', models.ForeignKey(blank=True, limit_choices_to={'is_virtual': '1'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='basedata.material', verbose_name='service name')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(blank=True, limit_choices_to={'is_virtual': '0'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='basedata.material', verbose_name='material')),
