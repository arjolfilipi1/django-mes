    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attach', models.FileField(blank=True, help_text='您可导入报价明细，模板请参考文档FD0006', null=True, upload_to='offer sheet', verbose_name='offer sheet file')),
                ...
                ('partner', models.ForeignKey(limit_choices_to={'partner_type': 'C'}, on_delete=django.db.models.deletion.CASCADE, to='basedata.partner', verbose_name='partner')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='offer man')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=0, verbose_name='executed')),
                ('event_time', models.DateTimeField(blank=True, null=True, verbose_name='event time')),
                ('material', models.ForeignKey(blank=True, limit_choices_to={'can_sale': '1', 'is_virtual': '0'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='basedata.material', verbose_name='material')),
                ...
                ('master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sale.offersheet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_type', models.CharField(choices=[], default='10', max_length=6, verbose_name='invoice type')),
                ('amount', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=12, null=True, verbose_name='money amount')),
                ('discount_amount', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=12, null=True, verbose_name='discount amount')),
                ('status', models.CharField(choices=[('0', 'NEW'), ('1', 'IN PROGRESS'), ('4', 'DROP'), ('9', 'APPROVED'), ('99', 'ALREADY STOCK OUT')], default='0', max_length=2, verbose_name='status')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='organ.organization', verbose_name='organization')),
                ('partner', models.ForeignKey(limit_choices_to={'partner_type': 'C'}, on_delete=django.db.models.deletion.CASCADE, to='basedata.partner', verbose_name='partner')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='sales man')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(blank=True, limit_choices_to={'can_sale': '1', 'is_virtual': '0'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='basedata.material', verbose_name='material')),
                ('measure', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='basedata.measure', verbose_name='measure')),
                ('master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sale.saleorder')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('so', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sale.saleorder', verbose_name='sale order')),
            ],
            options={
