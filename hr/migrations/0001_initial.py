    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.CharField(choices=[], default='10', max_length=2, verbose_name='classification')),
                ('plus_or_minus', models.CharField(choices=[], default='+', max_length=2, verbose_name='plus or minus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('probation_months', models.CharField(choices=[], default='3', max_length=2, verbose_name='probation months')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('calculate_way', models.CharField(choices=[], default='10', max_length=2, verbose_name='calculate way')),
                ...
                ('entry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.entry', verbose_name='employee entry')),
                ('salary_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.salaryitem', verbose_name='salary item')),
            ],
            options={
                'verbose_name': 'salary item',
