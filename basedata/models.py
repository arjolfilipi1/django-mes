...
class ValueList(generic.BO):
    ...
    module = models.ForeignKey(Module,verbose_name=_("module"),blank=True,null=True,on_delete=models.SET_NULL)
    ...
    locked_by = models.ForeignKey(User,verbose_name=_("locked by"),blank=True,null=True,on_delete=models.SET_NULL)
...
class ValueListItem(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['group', 'group_code']),
        ]
...
class Partner(generic.BO):
    ...
    org = models.ForeignKey(Organization,verbose_name=_("organization"),blank=True,null=True,on_delete=models.SET_NULL)
...
class BankAccount(generic.BO):
    ...
    partner = models.ForeignKey(Partner,verbose_name=_("partner"),blank=True,null=True,on_delete=models.SET_NULL)
    org = models.ForeignKey(Organization,verbose_name=_("organization"),blank=True,null=True,on_delete=models.SET_NULL)
...
class Project(generic.BO):
    ...
    partner = models.ForeignKey(Partner,blank=True,null=True,verbose_name=_("partner"),limit_choices_to={"partner_type":"C"},on_delete=models.SET_NULL)
...
class Brand(models.Model):
    ...
    """
    index_weight = 101
    trade = models.ForeignKey(Trade,verbose_name=_("trade"),null=True,blank=True,on_delete=models.SET_NULL)
    name = models.CharField(_("name"),max_length=const.DB_CHAR_NAME_120)
    pinyin = models.CharField(_("pinyin"),max_length=const.DB_CHAR_NAME_120,blank=True,null=True)
...
class Material(generic.BO):
    ...
    pinyin = models.CharField(_("pinyin"),max_length=const.DB_CHAR_NAME_120,blank=True,null=True)
    brand = models.ForeignKey(Brand,blank=True,null=True,verbose_name=_("brand"),on_delete=models.SET_NULL)
    category = models.ForeignKey(Category,blank=True,null=True,verbose_name=_("category"),on_delete=models.SET_NULL)
    ...
    warehouse = models.ForeignKey(Warehouse,blank=True,null=True,verbose_name=_("warehouse"),on_delete=models.SET_NULL)
    ...
    def __unicode__(self):
        ...
        return str(self.code) +" "+self.code(self.name)
...
class MaterialParam(models.Model):
    ...
    param_name = models.ForeignKey(TechnicalParameterName,blank=True,null=True,on_delete=models.SET_NULL)
...
class Employee(generic.BO):
    ...
    phone = models.CharField(_("phone"),max_length=const.DB_CHAR_NAME_20,blank=True,null=True)
    organization = models.ForeignKey(Organization,verbose_name = _('organization'),null=True,blank=True,on_delete=models.SET_NULL)
    ...
    def __str__(self):
        return self.name + " "+str(self.pinyin)
    def age(self):
        import datetime
        if self.birthday:
